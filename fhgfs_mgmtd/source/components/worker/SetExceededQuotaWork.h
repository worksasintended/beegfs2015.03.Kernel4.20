...
{
   public:
      SetExceededQuotaWork(QuotaDataType idType, QuotaLimitType limitType, Node* storageNode,
         int messageNumber, UIntList* idList, SynchronizedCounter *counter, int* result)
      {
