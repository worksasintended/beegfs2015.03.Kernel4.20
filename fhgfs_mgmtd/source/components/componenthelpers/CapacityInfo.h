...
class CapacityInfo
{
   public:
       ...
       */
      CapacityInfo(uint16_t nodeID, const std::string& nodeIDWithTypeStr,
...
{
   public:
      TargetCapacityInfo(const uint16_t targetID, const uint16_t nodeID) :
