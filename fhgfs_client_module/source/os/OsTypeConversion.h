...
static inline int OsTypeConv_openFlagsOsToFhgfs(int osFlags, fhgfs_bool isPagedMode);
 ...
 */
int OsTypeConv_openFlagsOsToFhgfs(int osFlags, fhgfs_bool isPagedMode)
{
   int fhgfsFlags = 0;
...
{
   os_memset(kStat, 0, sizeof(*kStat) );
