...
// virtual functions
extern void Raid10Pattern_serializePattern(StripePattern* this, char* buf);
extern fhgfs_bool Raid10Pattern_deserializePattern(StripePattern* this,
   const char* buf, size_t bufLen);
extern unsigned Raid10Pattern_serialLen(StripePattern* this);
...
void __Raid10Pattern_assignVirtualFunctions(Raid10Pattern* this)
{
   ...
   ( (StripePattern*)this)->serializePattern = Raid10Pattern_serializePattern;
   ( (StripePattern*)this)->deserializePattern = Raid10Pattern_deserializePattern;
   ( (StripePattern*)this)->serialLen = Raid10Pattern_serialLen;
