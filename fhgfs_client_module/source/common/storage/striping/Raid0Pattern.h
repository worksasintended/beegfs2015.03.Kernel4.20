...
// virtual functions
extern void Raid0Pattern_serializePattern(StripePattern* this, char* buf);
extern fhgfs_bool Raid0Pattern_deserializePattern(StripePattern* this,
   const char* buf, size_t bufLen);
extern unsigned Raid0Pattern_serialLen(StripePattern* this);
...
void __Raid0Pattern_assignVirtualFunctions(Raid0Pattern* this)
{
   ...
   ( (StripePattern*)this)->serializePattern = Raid0Pattern_serializePattern;
   ( (StripePattern*)this)->deserializePattern = Raid0Pattern_deserializePattern;
   ( (StripePattern*)this)->serialLen = Raid0Pattern_serialLen;
