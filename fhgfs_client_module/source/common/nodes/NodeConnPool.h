...
extern Socket* NodeConnPool_acquireStreamSocketEx(NodeConnPool* this, fhgfs_bool allowWaiting);
...
extern fhgfs_bool NodeConnPool_updateInterfaces(NodeConnPool* this, unsigned short streamPort,
...
extern unsigned __NodeConnPool_invalidateAvailableStreams(NodeConnPool* this,
   fhgfs_bool idleStreamsOnly);
extern void __NodeConnPool_resetStreamsIdleFlag(NodeConnPool* this);
extern fhgfs_bool __NodeConnPool_applySocketOptionsPreConnect(NodeConnPool* this, Socket* sock);
extern fhgfs_bool __NodeConnPool_applySocketOptionsConnected(NodeConnPool* this, Socket* sock);
...
extern void __NodeConnPool_setConnSuccess(NodeConnPool* this, uint32_t lastSuccessPeerIP,
   NicAddrType_t lastSuccessNicType);
extern fhgfs_bool __NodeConnPool_equalsLastSuccess(NodeConnPool* this, uint32_t lastSuccessPeerIP,
   NicAddrType_t lastSuccessNicType);
extern fhgfs_bool __NodeConnPool_isLastSuccessInitialized(NodeConnPool* this);
extern fhgfs_bool __NodeConnPool_shouldPrintConnectedLogMsg(NodeConnPool* this,
   uint32_t currentPeerIP, NicAddrType_t currentNicType);
extern fhgfs_bool __NodeConnPool_shouldPrintConnectFailedLogMsg(NodeConnPool* this,
   uint32_t currentPeerIP, NicAddrType_t currentNicType);
...
extern unsigned NodeConnPool_getFirstPeerName(NodeConnPool* this, NicAddrType_t nicType,
   ssize_t outBufLen, char* outBuf, fhgfs_bool* outIsNonPrimary);
...
static inline void NodeConnPool_setLogConnErrors(NodeConnPool* this, fhgfs_bool logConnErrors);
static inline fhgfs_bool __NodeConnPool_getWasLastTimeCompleteFail(NodeConnPool* this);
...
struct NodeConnPoolErrorState
{
   ...
   fhgfs_bool wasLastTimeCompleteFail; // true if last attempt failed on all routes
};
...
struct NodeConnPool
{
   ...
   fhgfs_bool logConnErrors; // false to disable logging during acquireStream() (e.g. for helperd)
...
void NodeConnPool_setLogConnErrors(NodeConnPool* this, fhgfs_bool logConnErrors)
{
 ...
 */
fhgfs_bool __NodeConnPool_getWasLastTimeCompleteFail(NodeConnPool* this)
{
