 ...
 */
void TargetStateStore_syncStatesAndGroupsFromLists(TargetStateStore* this,
   ...
   UInt16List* secondaryTargets)
{
   ...
   __MirrorBuddyGroupMapper_syncGroupsFromListsUnlocked(buddyGroups, buddyGroupIDs,
...
fhgfs_bool TargetStateStore_setAllStates(TargetStateStore* this, TargetReachabilityState state)
{
   TargetStateInfoMapIter statesMapIter;
   fhgfs_bool res = fhgfs_false;
