...
extern void TargetStateStore_syncStatesAndGroupsFromLists(TargetStateStore* this,
...
extern fhgfs_bool TargetStateStore_setAllStates(TargetStateStore* this,
...
static inline TargetStateInfo* TargetStateStore_getStateInfo(TargetStateStore* this,
   uint16_t targetID);
static inline fhgfs_bool TargetStateStore_getState(TargetStateStore* this, uint16_t targetID,
   CombinedTargetState* state);
static inline unsigned TargetStateStore_getStateLastChangedSec(TargetStateStore* this,
   uint16_t targetID);
static inline fhgfs_bool TargetStateStore_getValid(TargetStateStore* this);
...
fhgfs_bool TargetStateStore_getState(TargetStateStore* this, uint16_t targetID,
   CombinedTargetState* state)
{
...
fhgfs_bool TargetStateStore_getValid(TargetStateStore* this)
{
   return this->isValid;
}
