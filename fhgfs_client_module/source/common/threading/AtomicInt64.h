...
static inline AtomicInt64* AtomicInt64_construct(uint64_t initialVal);
static inline void AtomicInt64_uninit(AtomicInt64* this);
static inline void AtomicInt64_destruct(AtomicInt64* this);
...
AtomicInt64* AtomicInt64_construct(uint64_t initialVal)
{
   AtomicInt64* this = (AtomicInt64*)os_kmalloc(sizeof(*this) );

   AtomicInt64_init(this, initialVal);
...
void AtomicInt64_destruct(AtomicInt64* this)
{
   AtomicInt64_uninit(this);
