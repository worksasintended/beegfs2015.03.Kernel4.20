...
static inline AtomicInt* AtomicInt_construct(int initialVal);
static inline void AtomicInt_uninit(AtomicInt* this);
static inline void AtomicInt_destruct(AtomicInt* this);
...
AtomicInt* AtomicInt_construct(int initialVal)
{
   AtomicInt* this = (AtomicInt*)os_kmalloc(sizeof(*this) );

   AtomicInt_init(this, initialVal);
...
void AtomicInt_destruct(AtomicInt* this)
{
   AtomicInt_uninit(this);
