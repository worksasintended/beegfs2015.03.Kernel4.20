...
static inline PointerList* PointerList_construct(void);
static inline void PointerList_uninit(PointerList* this);
static inline void PointerList_destruct(PointerList* this);
...
static inline size_t PointerList_length(PointerList* this);
...
struct PointerList* PointerList_construct(void)
{
   PointerList* this = (PointerList*)os_kmalloc(sizeof(*this) );

   if(likely(this) )
      PointerList_init(this);
...
void PointerList_destruct(PointerList* this)
{
   PointerList_uninit(this);
...
void PointerList_removeHead(PointerList* this)
{
      ...
      if(!this->length)
      {
         BEEGFS_BUG_ON(fhgfs_true, "Attempt to remove head from empty list");
         return;
      }
   #endif
...
void PointerList_removeTail(PointerList* this)
{
      ...
      if(!this->length)
      {
         BEEGFS_BUG_ON(fhgfs_true, "Attempt to remove tail from empty list");
         return;
      }
   #endif
...
size_t PointerList_length(PointerList* this)
{
   return this->length;
}
