...
static inline Int64CpyList* Int64CpyList_construct(void);
static inline void Int64CpyList_uninit(Int64CpyList* this);
static inline void Int64CpyList_destruct(Int64CpyList* this);
...
struct Int64CpyList* Int64CpyList_construct(void)
{
   struct Int64CpyList* this = (Int64CpyList*)os_kmalloc(sizeof(*this) );

   if(likely(this) )
      Int64CpyList_init(this);
...
void Int64CpyList_destruct(Int64CpyList* this)
{
   Int64CpyList_uninit(this);
