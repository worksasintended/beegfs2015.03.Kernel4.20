...
static inline UInt16List* UInt16List_construct(void);
static inline void UInt16List_uninit(UInt16List* this);
static inline void UInt16List_destruct(UInt16List* this);
...
struct UInt16List* UInt16List_construct(void)
{
   struct UInt16List* this = (UInt16List*)os_kmalloc(sizeof(*this) );

   if(likely(this) )
      UInt16List_init(this);
...
void UInt16List_destruct(UInt16List* this)
{
   UInt16List_uninit(this);
