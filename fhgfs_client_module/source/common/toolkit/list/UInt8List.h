...
static inline UInt8List* UInt8List_construct(void);
static inline void UInt8List_uninit(UInt8List* this);
static inline void UInt8List_destruct(UInt8List* this);
...
struct UInt8List* UInt8List_construct(void)
{
   struct UInt8List* this = (UInt8List*)os_kmalloc(sizeof(*this) );
...
void UInt8List_destruct(UInt8List* this)
{
   UInt8List_uninit(this);
