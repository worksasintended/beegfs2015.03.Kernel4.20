...
static inline UInt16Vec* UInt16Vec_construct(void);
static inline void UInt16Vec_uninit(UInt16Vec* this);
static inline void UInt16Vec_destruct(UInt16Vec* this);
...
struct UInt16Vec* UInt16Vec_construct(void)
{
   struct UInt16Vec* this = (UInt16Vec*)os_kmalloc(sizeof(*this) );
...
void UInt16Vec_destruct(UInt16Vec* this)
{
   UInt16Vec_uninit(this);
...
void UInt16Vec_append(UInt16Vec* this, uint16_t value)
{
   ...
   { // double vector array size: alloc new, copy values, delete old, switch to new
      ...
      os_memcpy(newVecArray, this->vecArray, this->vecArrayLen * sizeof(uint16_t) );
