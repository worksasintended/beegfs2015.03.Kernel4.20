...
static inline StrCpyVec* StrCpyVec_construct(void);
static inline void StrCpyVec_uninit(StrCpyVec* this);
static inline void StrCpyVec_destruct(StrCpyVec* this);
...
struct StrCpyVec* StrCpyVec_construct(void)
{
   struct StrCpyVec* this = (StrCpyVec*)os_kmalloc(sizeof(StrCpyVec) );
...
void StrCpyVec_destruct(StrCpyVec* this)
{
   StrCpyVec_uninit(this);
...
void StrCpyVec_append(StrCpyVec* this, const char* valuePointer)
{
   ...
   { // double vector array size (create new, copy, exchange, delete old)
      ...
      os_memcpy(newVecArray, this->vecArray, this->vecArrayLen*sizeof(char*) );
      os_kfree(this->vecArray);
