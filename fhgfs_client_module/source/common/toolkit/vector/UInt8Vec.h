...
static inline UInt8Vec* UInt8Vec_construct(void);
static inline void UInt8Vec_uninit(UInt8Vec* this);
static inline void UInt8Vec_destruct(UInt8Vec* this);
...
struct UInt8Vec* UInt8Vec_construct(void)
{
   struct UInt8Vec* this = (UInt8Vec*)os_kmalloc(sizeof(*this) );
...
void UInt8Vec_destruct(UInt8Vec* this)
{
   UInt8Vec_uninit(this);
...
void UInt8Vec_append(UInt8Vec* this, uint8_t value)
{
   ...
   { // double vector array size: alloc new, copy values, delete old, switch to new
      ...
      os_memcpy(newVecArray, this->vecArray, this->vecArrayLen * sizeof(uint8_t) );
