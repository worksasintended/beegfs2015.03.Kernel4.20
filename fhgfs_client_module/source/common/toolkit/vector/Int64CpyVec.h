...
static inline Int64CpyVec* Int64CpyVec_construct(void);
static inline void Int64CpyVec_uninit(Int64CpyVec* this);
static inline void Int64CpyVec_destruct(Int64CpyVec* this);
...
struct Int64CpyVec* Int64CpyVec_construct(void)
{
   struct Int64CpyVec* this = (Int64CpyVec*)os_kmalloc(sizeof(*this) );
   
   if(likely(this) )
      Int64CpyVec_init(this);
...
void Int64CpyVec_destruct(Int64CpyVec* this)
{
   Int64CpyVec_uninit(this);
...
void Int64CpyVec_append(Int64CpyVec* this, int64_t value)
{
   ...
   { // double vector array size (create new, copy, exchange, delete old)
      ...
      os_memcpy(newVecArray, this->vecArray, this->vecArrayLen*sizeof(int64_t*) );
      os_kfree(this->vecArray);
