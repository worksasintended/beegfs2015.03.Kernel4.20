...
static inline Time* Time_construct(void);
static inline void Time_uninit(Time* this);
static inline void Time_destruct(Time* this);

static inline void Time_setToNow(Time* this);
static inline void Time_setZero(Time* this);
static inline fhgfs_bool Time_getIsZero(Time* this);
...
// operators
static inline fhgfs_bool Time_equals(Time* this, Time* other);
static inline fhgfs_bool Time_notequals(Time* this, Time* other);
...
Time* Time_construct(void)
{
   Time* this = (Time*)os_kmalloc(sizeof(*this) );
...
fhgfs_bool Time_getIsZero(Time* this)
{
...
fhgfs_bool Time_equals(Time* this, Time* other)
{
   return (this->now.tv_nsec == other->now.tv_nsec) && (this->now.tv_sec == other->now.tv_sec);
}


fhgfs_bool Time_notequals(Time* this, Time* other)
{
   return (this->now.tv_nsec != other->now.tv_nsec) || (this->now.tv_sec != other->now.tv_sec);
}
