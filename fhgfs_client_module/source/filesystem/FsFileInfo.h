...
struct IntCpyVec; // forward declaration
...
extern void FsFileInfo_setAppending(FsFileInfo* this, fhgfs_bool appending);
extern fhgfs_bool FsFileInfo_getAppending(FsFileInfo* this);
extern ssize_t FsFileInfo_getCacheHits(FsFileInfo* this);
extern void FsFileInfo_setAllowCaching(FsFileInfo* this, fhgfs_bool allowCaching);
extern fhgfs_bool FsFileInfo_getAllowCaching(FsFileInfo* this);
...
extern fhgfs_bool FsFileInfo_getUsedEntryLocking(FsFileInfo* this);
