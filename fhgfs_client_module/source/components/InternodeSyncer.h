...
/*
 * note: some part of this is declared in the include_closed tree.
 */
...
extern fhgfs_bool InternodeSyncer_waitForMgmtInit(InternodeSyncer* this, int timeoutMS);
...
extern fhgfs_bool __InternodeSyncer_waitForMgmtHeartbeat(InternodeSyncer* this);

extern fhgfs_bool __InternodeSyncer_registerNode(InternodeSyncer* this);
extern void __InternodeSyncer_reregisterNode(InternodeSyncer* this);
extern fhgfs_bool __InternodeSyncer_unregisterNode(InternodeSyncer* this);
...
// getters & setters
static inline fhgfs_bool InternodeSyncer_getValid(InternodeSyncer* this);
static inline void InternodeSyncer_setForceTargetStatesUpdate(InternodeSyncer* this);
static inline fhgfs_bool InternodeSyncer_getAndResetForceTargetStatesUpdate(InternodeSyncer* this);
...
struct DelayedCloseEntry
{
   ...
   fhgfs_bool needsAppendLockCleanup;
...
struct InternodeSyncer
{
   ...
   fhgfs_bool nodeRegistered; // true if the mgmt host ack'ed our heartbeat

   fhgfs_bool forceTargetStatesUpdate; // force an update of target states
...
fhgfs_bool InternodeSyncer_getValid(InternodeSyncer* this)
{
...
void InternodeSyncer_setForceTargetStatesUpdate(InternodeSyncer* this)
{
   ...
   this->forceTargetStatesUpdate = fhgfs_true;

   Mutex_unlock(this->forceTargetStatesUpdateMutex); // U N L O C K
}

fhgfs_bool InternodeSyncer_getAndResetForceTargetStatesUpdate(InternodeSyncer* this)
{
   fhgfs_bool retVal;
