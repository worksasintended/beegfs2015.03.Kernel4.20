...
extern fhgfs_bool __Logger_checkThreadMultiLock(Logger* this);
...
extern fhgfs_bool Logger_getLogTopicFromStr(const char* logTopicStr, LogTopic* logTopic);
