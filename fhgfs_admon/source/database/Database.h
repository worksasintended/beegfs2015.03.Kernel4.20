...
class Database
{
   public:
      ...
      void insertMetaNodeData(std::string nodeID, uint16_t nodeNumID, MetaNodeDataContent data);
      void insertMetaNodeData(std::string nodeID, uint16_t nodeNumID, TabType tabType,
         MetaNodeDataContent data);
      void getMetaNodeSets(uint16_t nodeNumID, TabType tabType, long minTime, long maxTime,
         MetaNodeDataContentList *outList);
      void insertStorageNodeData(std::string nodeID, uint16_t nodeNumID,
         StorageNodeDataContent data);
      void insertStorageNodeData(std::string nodeID,  uint16_t nodeNumID, TabType tabType,
         StorageNodeDataContent data);
      void getStorageNodeSets(uint16_t nodeNumID, TabType tabType, long minTime, long maxTime,
         StorageNodeDataContentList *outList);
      void getStorageNodes(StringList *outList);
      void getMetaNodes(StringList *outList);
      void getStorageNodes(UInt16List *outList);
      void getMetaNodes(UInt16List *outList);
      ...
      int addMetaNodeToGroup(std::string nodeID, uint16_t nodeNumID, int groupID);
      int delGroup(int groupID);
      int delGroup(std::string groupName);
      int addMetaNodeToGroup(std::string nodeID, uint16_t nodeNumID, std::string groupName);
      int delMetaNodeFromGroup(uint16_t nodeNumID, int groupID);
      int delMetaNodeFromGroup(uint16_t nodeNumID, std::string groupName);
      int addStorageNodeToGroup(std::string nodeID, uint16_t nodeNumID, int groupID);
      int addStorageNodeToGroup(std::string nodeID, uint16_t nodeNumID, std::string groupName);
      int delStorageNodeFromGroup(uint16_t nodeNumID, int groupID);
      int delStorageNodeFromGroup(uint16_t nodeNumID, std::string groupName);
      ...
      void getMetaNodesInGroup(int groupID, UInt16List *outNodes);
      void getMetaNodesInGroup(std::string groupName, UInt16List *outNodes);
      void getMetaNodesWithoutGroup(StringList *outGroups);
      ...
      void getStorageNodesInGroup(int groupID, UInt16List *outNodes);
      void getStorageNodesInGroup(std::string groupName, UInt16List *outNodes);
      void cleanUp();
      bool metaNodeIsInGroup(uint16_t nodeNumID, int group);
      bool metaNodeIsInGroup(uint16_t nodeNumID, std::string group);
      bool storageNodeIsInGroup(uint16_t nodeNumID, int group);
      bool storageNodeIsInGroup(uint16_t nodeNumID, std::string group);
      int metaNodeGetGroup(uint16_t nodeNumID);
      int storageNodeGetGroup(uint16_t nodeNumID);
