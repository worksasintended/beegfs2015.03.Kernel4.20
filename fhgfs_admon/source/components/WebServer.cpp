   ...
   const struct mg_request_info *request_info)
{
   ...
   Program::getApp()->getLogger()->log(Log_DEBUG, "WebSrv", "Requested URI: " +
...
int WebServer::requestHandler(struct mg_connection *conn)
{
   ...
   { // a URI which is polled every x seconds
      XmlCreator::clientStats(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_UserStats") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::userStats(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_Storagenode") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::storageNode(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_StoragenodesOverview") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::storageNodesOverview(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_Metanode") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::metaNode(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_MetanodesOverview") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::metaNodesOverview(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_KnownProblems") == 0)
   { // a URI which is polled every x seconds
      XmlCreator::knownProblems(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_GetNonce") == 0)
   {
      XmlCreator::getNonce(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_AuthInfo") == 0)
   {
      XmlCreator::authInfo(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_ChangePW") == 0)
   {
      XmlCreator::changePassword(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_CheckDistriArch") == 0)
   {
      XmlCreator::checkDistriArch(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_CheckSSH") == 0)
   {
      XmlCreator::checkSSH(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_ConfigBasicConfig") == 0)
   {
      XmlCreator::configBasicConfig(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_ConfigIBConfig") == 0)
   {
      XmlCreator::configIBConfig(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_ConfigRoles") == 0)
   {
      XmlCreator::configRoles(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_FileBrowser") == 0)
   {
      XmlCreator::fileBrowser(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_GetCheckClientDependenciesLog") == 0)
   {
      XmlCreator::getCheckClientDependenciesLog(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_GetGroups") == 0)
   {
      XmlCreator::getGroups(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_Install") == 0)
   {
      XmlCreator::install(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_InstallInfo") == 0)
   {
      XmlCreator::installInfo(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_Uninstall") == 0)
   {
      XmlCreator::uninstall(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_LogFile") == 0)
   {
      XmlCreator::getLocalLogFile(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_MailNotification") == 0)
   {
      XmlCreator::mailNotification(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_NodeList") == 0)
   {
      XmlCreator::nodeList(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_PreAuthInfo") == 0)
   {
      XmlCreator::preAuthInfo(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_StartStop") == 0)
   {
      XmlCreator::startStop(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_Striping") == 0)
   {
      XmlCreator::striping(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_ScriptSettings") == 0)
   {
      XmlCreator::scriptSettings(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_CreateNewSetupLogfile") == 0)
   {
      XmlCreator::createNewSetupLogfile(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_GetLogFile") == 0)
   {
      XmlCreator::getRemoteLogFile(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/beegfs-admon-gui.jar") == 0)
   {
      XmlCreator::admonGui(conn, requestInfo);
   }
   ...
   {
      XmlCreator::getVersionString(conn, requestInfo, postData, postDataLen);
   }
   else if (strcmp(requestInfo->uri, "/XML_TestEMail") == 0)
   {
      XmlCreator::testEMail(conn, requestInfo, postData, postDataLen);
   }
   else
   {
      ...
      XmlCreator::sendHttpError(conn, requestInfo, httpErrorCodeNotFound, errorMessage);
   }
