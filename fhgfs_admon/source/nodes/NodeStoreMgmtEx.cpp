...
NodeStoreMgmtEx::NodeStoreMgmtEx() throw(InvalidConfigException) :
...
bool NodeStoreMgmtEx::addOrUpdateNode(MgmtNodeEx** node)
{
 ...
 */
bool NodeStoreMgmtEx::addOrUpdateNode(Node** node)
{
...
bool NodeStoreMgmtEx::addOrUpdateNodeEx(Node** node, uint16_t* outNodeNumID)
{
   ...
   { // new node
      ...
      MgmtNodeEx* mgmtdNode = new MgmtNodeEx(
...
void NodeStoreMgmtEx::releaseMgmtNode(MgmtNodeEx** node)
{
