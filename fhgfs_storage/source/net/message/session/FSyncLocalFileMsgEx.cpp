...
bool FSyncLocalFileMsgEx::processIncoming(struct sockaddr_in* fromAddr, Socket* sock,
   char* respBuf, size_t bufLen, HighResolutionStats* stats)
{
   const char* logContext = "FSyncLocalFileMsg incoming";
      ...
      LOG_DEBUG(logContext, Log_DEBUG,
         std::string("Received a FSyncLocalFileMsg from: ") + peer);
   #endif // BEEGFS_DEBUG
   ...
   FSyncLocalFileRespMsg respMsg(clientRes);
