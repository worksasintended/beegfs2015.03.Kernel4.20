 ...
 */
int ModeClientStats::addNodesToNodeStore(App* app, NodeStoreServers* mgmtNodes, Node** outMgmtNode)
{
 ...
 */
void ModeClientStats::deleteListNodesExceptProvided(NodeList* nodeList, uint16_t exceptID)
{
   ...
   while (iter != nodeList->end() )
   {
      ...
      if (currentNode->getNumID() == exceptID)
      {
         iter++;
         continue;
      }
