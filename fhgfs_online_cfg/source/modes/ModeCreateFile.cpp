...
bool ModeCreateFile::communicate(Node* ownerNode, EntryInfo* entryInfo, FileSettings* settings)
{
   return communicateWithPattern(ownerNode, entryInfo, settings);
}
