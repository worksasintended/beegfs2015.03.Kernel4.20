...
class ModeReverseLookup : public Mode
{
   ...
   private:
      ...
      bool getLinkOwnerInfo(std::string id, NodeList *metaNodes,
         std::string *outLinkOwnerID, std::string *outParentID);
      bool lookupId(std::string id, NodeList *metaNodes, std::string *outName,
         std::string *outParentID);
      bool lookupIdOnSingleMDS(std::string id, Node *node, std::string *outName,
         std::string *outParentID);
