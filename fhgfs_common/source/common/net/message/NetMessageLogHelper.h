   ...
   public:
      NetMsgStrMapping()
      {
         ...
         */
         ...
         this->defineToStrMap[NETMSGTYPE_GamReleaseFiles] = "GamReleaseFiles";
         this->defineToStrMap[NETMSGTYPE_GamReleaseFilesResp] = "GamReleaseFilesResp";
         this->defineToStrMap[NETMSGTYPE_GamReleaseFilesMeta] = "GamReleaseFilesMeta";
         this->defineToStrMap[NETMSGTYPE_GamReleaseFilesMetaResp] = "GamReleaseFilesMetaResp";
         this->defineToStrMap[NETMSGTYPE_GamRecalledFiles] = "GamRecalledFiles";
         this->defineToStrMap[NETMSGTYPE_GamRecalledFilesMeta] = "GamRecalledFilesMeta";
         this->defineToStrMap[NETMSGTYPE_GamSetCollocationID] = "GamSetCollocationID";
         this->defineToStrMap[NETMSGTYPE_GamSetCollocationIDResp] = "GamSetCollocationIDResp";
         this->defineToStrMap[NETMSGTYPE_GamGetChunkCollocationID] = "GamGetChunkCollocationID";
         this->defineToStrMap[NETMSGTYPE_GamGetChunkCollocationIDResp] = "GamGetChunkCollocationIDResp";
         this->defineToStrMap[NETMSGTYPE_GamGetCollocationIDMeta] = "GamGetCollocationIDMeta";
         this->defineToStrMap[NETMSGTYPE_GamGetCollocationIDMetaResp] = "GamGetCollocationIDMetaResp";
         this->defineToStrMap[NETMSGTYPE_GamArchiveFiles] = "GamArchiveFiles";
      }
