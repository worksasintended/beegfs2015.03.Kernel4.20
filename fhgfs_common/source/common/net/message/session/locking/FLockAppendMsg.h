...
class FLockAppendMsg : public NetMessage
{
   public:
       ...
       */
      FLockAppendMsg(const char* clientID, const char* fileHandleID, int64_t clientFD, int ownerPID,
         int lockTypeFlags, const char* lockAckID) : NetMessage(NETMSGTYPE_FLockAppend)
      {
   ...
   protected:
       ...
       */
      FLockAppendMsg() : NetMessage(NETMSGTYPE_FLockAppend) {}
