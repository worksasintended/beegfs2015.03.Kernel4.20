...
class StripePattern
{
   public:
      ...
      static std::string getPatternTypeStr(unsigned patternType);
   ...
   public:
      ...
      /**
       * Get copy of mirror stripe target IDs.
       *
       * do nothing for patterns that don't have mirror targets.
       */
      virtual void getMirrorTargetIDs(UInt16Vector* outMirrorTargetIDs) const
      {
      }
