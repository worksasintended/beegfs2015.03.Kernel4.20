...
class StreamListenerV2 : public PThread
{
   ...
   public:
      StreamListenerV2(std::string listenerID, AbstractApp* app, MultiWorkQueue* workQueue)
   ...
   private:
      ...
      MultiWorkQueue*   workQueue; // may be NULL in derived classes with own getWorkQueue()
