...
{
   {1 + ( ( (32*1)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 1 to 32
   {1 + ( ( (32*2)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 33 to 64
   {1 + ( ( (32*3)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 65 to 96
   {1 + ( ( (32*4)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 97 to 128
   {1 + ( ( (32*5)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 129 to 160
   {1 + ( ( (32*6)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 161 to 192
   {1 + ( ( (32*7)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 193 to 224
   {1 + ( ( (32*8)-1) / BITSTORE_BLOCK_BIT_COUNT) },        // result for bits 125 to 256
};
